...
class KniEntity {
    ...
    override fun toString(): String {
        return "KniEntity(str='$str', intValue=$intValue, floatValue=$floatValue, " +
            "doubleValue=$doubleValue, boolValue=$boolValue, byteValue=$byteValue, " +
            "shortValue=$shortValue, longValue=$longValue, charValue=$charValue, " +
            "byteArray=${byteArray.contentToString()}, intArray=${intArray.contentToString()}, " +
            "floatArray=${floatArray.contentToString()}, doubleArray=${doubleArray.contentToString()}, " +
            "boolArray=${boolArray.contentToString()}, intList=$intList)"
    }
}
