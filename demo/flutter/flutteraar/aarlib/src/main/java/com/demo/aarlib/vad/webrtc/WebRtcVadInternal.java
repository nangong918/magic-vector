...
class WebRtcVadInternal {
    ...
    private static final FrameSize DEFAULT_FRAME_SIZE = FrameSize.FRAME_SIZE_240;
    private static final Mode DEFAULT_MODE = Mode.VERY_AGGRESSIVE;
    ...
    void start(Context context) {
        ...
        emit("state", "webrtc已开始监听", stateExtras(true));
    }
    ...
    void stop() {
        ...
        emit("state", "webrtc已停止监听", stateExtras(false));
    }
