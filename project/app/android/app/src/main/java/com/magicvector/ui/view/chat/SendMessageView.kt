...
private fun KeyboardLayout(
    ...
    ConstraintLayout(
        ...
        Box(
            ...
            Icon(
                painter = painterResource(com.view.appview.R.drawable.image_24px),
        ...
        Box(
            ...
            Icon(
                painter = painterResource(com.view.appview.R.drawable.send_24px),
...
private fun AudioLayout(
    ...
    ConstraintLayout(
        ...
        Box(
            ...
            Icon(
                painter = painterResource(com.view.appview.R.drawable.videocam_24px),
        ...
        Box(
            ...
            Icon(
                painter = painterResource(com.view.appview.R.drawable.keyboard_24px),
